...
parser.add_argument('--corruption', type=str, default='all', choices=['all', 'gaussian_noise', 'traffic', 'crowd', 'rain', 'thunder', 'wind'], help='Type of corruption to apply')
parser.add_argument('--severity', type=int, default=5, choices=[1, 2, 3, 4, 5], help='Severity of corruption to apply')
# Kinetics50
parser.add_argument('--data_path', type=str, default='data_path/Kinetics50/audio_val256_k=50', help='Path to test data')
parser.add_argument('--save_path', type=str, default='data_path/Kinetics50/audio_val256_k=50-C', help='Path to store corruption data')
parser.add_argument('--weather_path', type=str, default='data_path/NoisyAudios/', help='Path to store corruption data')
# VGGSound
# parser.add_argument('--data_path', type=str, default='data_path/VGGSound/audio_test', help='Path to test data')
# parser.add_argument('--save_path', type=str, default='data_path/VGGSound/audio_test-C', help='Path to store corruption data')
# parser.add_argument('--weather_path', type=str, default='data_path/NoisyAudios/', help='Path to store corruption data')
