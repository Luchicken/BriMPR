...
# ImageMagick
os.environ['MAGICK_HOME'] = '/home/ljc/tools/imagemagick'
...
# Kinetics50
parser.add_argument('--data_path', type=str, default='data_path/Kinetics50/image_mulframe_val256_k=50', help='Path to test data')
parser.add_argument('--save_path', type=str, default='data_path/Kinetics50/image_mulframe_val256_k=50-C', help='Path to store corruption data')
# VGGSound
